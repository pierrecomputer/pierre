...
<ComponentTabs
  reactAPIMultiFileDiff={props.reactAPIMultiFileDiff}
  reactAPIFileDiff={props.reactAPIFileDiff}
  reactAPIPatch={props.reactAPIPatch}
  reactAPIFile={props.reactAPIFile}
/>
...
<SharedPropTabs
  sharedDiffOptions={props.sharedDiffOptions}
  sharedDiffRenderProps={props.sharedDiffRenderProps}
  sharedFileOptions={props.sharedFileOptions}
  sharedFileRenderProps={props.sharedFileRenderProps}
/>
