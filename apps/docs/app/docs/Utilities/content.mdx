...
<AcceptRejectTabs
  diffAcceptReject={props.diffAcceptReject}
  diffAcceptRejectReact={props.diffAcceptRejectReact}
/>
...
<DocsCodeExample {...props.disposeHighlighter} />
...
<DocsCodeExample {...props.getSharedHighlighter} />
...
<DocsCodeExample {...props.parseDiffFromFile} />
...
<DocsCodeExample {...props.parsePatchFiles} />
...
<DocsCodeExample {...props.preloadHighlighter} />
...
<DocsCodeExample {...props.registerCustomTheme} />
...
<DocsCodeExample {...props.setLanguageOverride} />
