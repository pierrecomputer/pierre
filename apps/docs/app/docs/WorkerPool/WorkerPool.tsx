  ...
  return (
    <section className="space-y-4">
      ...
      <Notice icon={<IconCiWarningFill />}>
        We’ve only tested the Vite and NextJS examples—the rest were generated
        by AI. If any of them are incorrect, please let us know.
      </Notice>
      ...
      <Notice icon={<IconCiWarningFill />}>
        Workers only work in client components. Make sure your function has the{' '}
      ...
      <Notice variant="warning" icon={<IconCiWarningFill />}>
        The worker pool only works in client components. Make sure your provider
        is in a component with the <code>'use client'</code> directive if you're
        using NextJS App Router. Workers cannot be instantiated during
