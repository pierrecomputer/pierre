    ...
    <section className="space-y-4">
      ...
      {showUnsafe && (
        <>
          ...
          <p>
            For advanced customization, you can inject arbitrary CSS into the
            shadow DOM using the <code>unsafeCSS</code> option. This CSS will be
            wrapped in an <code>@layer unsafe</code> block, giving it the
            highest priority in the cascade. Use this sparingly and with
            caution, as it bypasses the normal style isolation.
          </p>
          <p className="font-semibold italic">
            ...
            across any future changes to the library, even in patch versions.
            Please reach out so that we can discuss a more permanent solution
            for the style change that you're looking for.
          </p>
