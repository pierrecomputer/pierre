...
and modify the color palette. The repo uses TypeScript to generate theme JSON
files, giving you type safety and the ability to generate multiple theme
files—for various editors, too—from a single color palette.
