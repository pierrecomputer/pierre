...
<CodeToggle
  reactSingleFile={props.reactSingleFile}
  reactPatchFile={props.reactPatchFile}
  vanillaSingleFile={props.vanillaSingleFile}
  vanillaPatchFile={props.vanillaPatchFile}
/>
