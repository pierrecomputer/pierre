...
<VanillaComponentTabs
  fileDiffExample={props.fileDiffExample}
  fileExample={props.fileExample}
/>
...
<VanillaPropTabs
  fileDiffProps={props.fileDiffProps}
...
<DocsCodeExample {...props.customHunk} />
...
<DiffHunksTabs
  diffHunksRenderer={props.diffHunksRenderer}
  diffHunksRendererPatch={props.diffHunksRendererPatch}
/>
...
<DocsCodeExample {...props.fileRenderer} />
