...
| `viewportHeight`          | Visible window height for virtualization.                         | Fixed-height trees and predictable rendering.                                |
...
`viewportHeight`, `itemHeight`, and `overscan` are rendering knobs, not
onboarding concepts. They tune the built-in virtualized row window after you
have already picked the right data-shaping path.
