...
pass a list of file paths (and optional [options](#filetree-options)); the tree
builds the hierarchy and handles expand/collapse, selection, and search.
Examples for both environments are below.
