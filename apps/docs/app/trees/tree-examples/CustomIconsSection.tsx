...
<svg data-icon-sprite aria-hidden="true" width="0" height="0">
  ...
  <symbol id="custom-folder-icon" viewBox="0 0 16 16" fill="none">
    <path d="M11.5003 6C11.6962 6.0001 11.8742 6.11464 11.9553 6.29297C12.0363 6.47155 12.0053 6.68149 11.8762 6.8291L8.37623 10.8291C8.28134 10.9375 8.14431 10.9999 8.00025 11C7.85615 11 7.71921 10.9375 7.62427 10.8291L4.12427 6.8291C3.99508 6.68145 3.9641 6.47162 4.04517 6.29297C4.12635 6.11462 4.30426 6 4.50025 6H11.5003Z" fill="currentcolor"/>
  </symbol>
          ...
          <FileTree
            ...
            options={{
              ...
              icons: {
                ...
                remap: {
                  'file-tree-icon-file': 'custom-file-icon',
