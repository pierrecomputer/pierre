...
export const CodeViewHeader = memo(function CodeViewHeader({
  ...
  return (
    <div
      className={cn(
        'z-10 contain-layout contain-paint flex flex-wrap md:flex-nowrap items-center gap-2.5 pt-3 pb-2 px-4 md:px-3 md:py-1.5 border-b border-[var(--color-border-opaque)] bg-background md:bg-neutral-50 md:dark:bg-[#101010]',
        className
      )}
    >
      <Link
