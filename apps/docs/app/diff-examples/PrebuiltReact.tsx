    ...
    <div className="space-y-5">
      <div className="space-y-4">
        <FeatureHeader
          ...
          description={
            <>
              No two codebases are alike, so we give you the freedom to
              implement <code>@pierre/precision-diffs</code> however you like.
              Components are logically separated—file wrapper, header, hunk, and
              more—and are all available in React or JavaScript versions.
            </>
          }
        />
