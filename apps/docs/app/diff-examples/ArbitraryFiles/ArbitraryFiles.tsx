  ...
  return (
    <div className="scroll-mt-[20px] space-y-5" id="arbitrary">
      <FeatureHeader
        ...
        description="In addition to rendering standard Git diffs and patches, you can pass any two files in Diffs and get a diff between them. This is especially useful when comparing across generative snapshots where linear history isn't always available. Edit the css below to see the diff."
      />
