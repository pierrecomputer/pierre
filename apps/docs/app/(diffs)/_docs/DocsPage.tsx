...
import {
  EDIT_EDITOR_STATE_EXAMPLE,
  EDIT_EDITOR_STATE_REACT_EXAMPLE,
...
async function EditSection() {
  const [
    ...
    editEditorStateExample,
    editEditorStateReactExample,
    editMarkerType,
    editMarkerExample,
    ...
    preloadFile(EDIT_EDITOR_STATE_EXAMPLE),
    preloadFile(EDIT_EDITOR_STATE_REACT_EXAMPLE),
