...
runs on [Shiki](https://shiki.style/) by default, with our own
[Highlights](#highlights) engine available as an alternative backend; both
provide a lot of great theme and language support.
