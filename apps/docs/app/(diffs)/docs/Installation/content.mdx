...
| Package                | Description                                                                                            |
| ---------------------- | ------------------------------------------------------------------------------------------------------ |
| `@pierre/diffs`        | [Vanilla JS components](#vanilla-js-api), including `CodeEditor`, plus [utility functions](#utilities) |
| `@pierre/diffs/react`  | [React components](#react-api) for rendering diffs, files, and `CodeEditor`                            |
| `@pierre/diffs/editor` | Low-level [edit mode](#edit-mode) `Editor` for attaching editing to rendered file and diff surfaces    |
