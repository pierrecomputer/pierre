...
const editDescription =
  'A lightweight, SSR, mobile-friendly editable file and diff layer for @pierre/diffs. Edit files and diffs in place with inline edit predictions, selection management, multiple cursors, undo history, find/replace, and lint markers.';
