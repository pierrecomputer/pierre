...
export function IconInProgress({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M13.25 8a5.25 5.25 0 0 1-4.75 5.227.466.466 0 0 1-.5-.477v-9.5c0-.276.224-.502.5-.477.591.056 1.154.21 1.672.446a5.26 5.26 0 0 1 2.876 3.333c.131.46.202.946.202 1.448" />
