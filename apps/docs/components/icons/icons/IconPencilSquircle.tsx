...
export function IconPencilSquircle({
  ...
  return (
    ...
    >
      ...
      <path d="m15.44.94-.38-.38a1.5 1.5 0 0 0-2.12 0L6.537 6.963a.3.3 0 0 0-.057.089l-1.288 3.434a.25.25 0 0 0 .322.322L8.948 9.52a.3.3 0 0 0 .09-.057l6.4-6.401a1.5 1.5 0 0 0 0-2.122" />
    </svg>
  );
}
