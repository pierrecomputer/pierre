...
export function IconArrowUpRight({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M5 4.75A.75.75 0 0 1 5.75 4h5.5a.75.75 0 0 1 .75.75v5.5a.75.75 0 0 1-1.5 0V6.56l-4.97 4.97a.75.75 0 0 1-1.06-1.06L9.44 5.5H5.75A.75.75 0 0 1 5 4.75" />
    </svg>
  );
}
