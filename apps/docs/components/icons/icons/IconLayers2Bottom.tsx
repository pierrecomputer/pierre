...
export function IconLayers2Bottom({
  ...
  return (
    ...
    >
      <path
        d="M7.553 2.224a1 1 0 0 1 .894 0l6.658 3.329a.5.5 0 0 1 0 .894l-6.658 3.33-.107.045a1 1 0 0 1-.68 0l-.107-.046L.894 6.447a.5.5 0 0 1 0-.894zM3.354 6 8 8.322 12.645 6 8 3.677z"
        clip-rule="evenodd"
        opacity=".4"
      />
