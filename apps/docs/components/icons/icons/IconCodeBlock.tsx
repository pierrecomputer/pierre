...
export function IconCodeBlock({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M7.31 6.248a.75.75 0 1 0-1.12-.996l-2 2.25a.75.75 0 0 0 0 .996l2 2.25a.75.75 0 1 0 1.12-.996L5.754 8zM8.752 5.19a.75.75 0 0 0-.063 1.058L10.246 8 8.69 9.752a.75.75 0 0 0 1.122.996l2-2.25a.75.75 0 0 0 0-.996l-2-2.25a.75.75 0 0 0-1.06-.063" />
