...
export const IconArrowsExpand = ({
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={width} height={height} fill={Colors[color as 'black'] || color} style={style} className={`pi ${className ? className : ''}`} {...props}><path d="M9 1.75A.75.75 0 0 1 9.75 1h4.5a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 1-1.5 0V3.56l-3.47 3.47a.75.75 0 1 1-1.06-1.06l3.47-3.47H9.75A.75.75 0 0 1 9 1.75m-2 12.5a.75.75 0 0 1-.75.75h-4.5a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 1 1.5 0v2.69l3.47-3.47a.75.75 0 0 1 1.06 1.06L3.56 13.5h2.69a.75.75 0 0 1 .75.75"/></svg>
	);
};
