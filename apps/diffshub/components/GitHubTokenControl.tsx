  ...
  return (
    <section className={cn('px-2 py-1.5', className)} aria-label={title}>
      <div className="flex items-center gap-2 text-sm font-medium">
        ...
        <span className="text-muted-foreground rounded-full border border-current/20 px-1.5 py-0.5 text-[10px] leading-none tracking-wide uppercase">
      ...
      <form className="mt-2 flex gap-1.5" onSubmit={handleSubmit}>
        <input
          ...
          type="password"
          autoComplete="off"
          placeholder={active ? 'Replace token' : 'Paste token'}
          value={draftToken}
