...
| Export                           | Kind     | Purpose                                                      |
| -------------------------------- | -------- | ------------------------------------------------------------ |
| `createAnnotationElement`        | Function | Creates an HTML tree annotation row from an annotation span. |
| `createAnnotationWrapperNode`    | Function | Creates a DOM host for an annotation slot.                   |
| `DiffDecoration`                 | Type     | Describes one inline diff range on a line.                   |
...
| `createTextNode`                 | Function | Creates an HTML tree text node.                              |
...
| `toHtml`                         | Function | Serializes HTML tree nodes to an HTML string.                |
| `escapeHTML`                     | Function | Escapes text for HTML output.                                |
