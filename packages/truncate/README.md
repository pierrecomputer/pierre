...
Quick helpers for implementing custom truncation experiences, most commonly 'middle truncation.'
...
This allows you to specificy a fixed size of characters (more technically graphemes) of the second segment.
