...
The HTML, token, and streaming results were recorded on **2026-09-25**, using
Bun 1.4.0 on an Apple M4 Pro (14 cores, 48 GiB RAM, macOS arm64). The optimized
Wasm build measured 161,909 bytes, or 75,322 bytes gzipped. Those tables
...
| --------------------------- | -----------------: | ---------: | -----------------: | ----: |
| `tiny.css.txt` (2 KiB)      |                511 | 413 (633×) |       13.0 (20.0×) |  0.65 |
| `tiny.html.txt` (2 KiB)     |                592 | 475 (329×) |                  — |  1.44 |
| `tiny.jsonc.txt` (2 KiB)    |                860 | 648 (129×) |       19.5 (3.89×) |  5.02 |
| `tiny.ts.txt` (2 KiB)       |                470 | 410 (264×) |       10.5 (6.75×) |  1.55 |
| `small.css.txt` (24 KiB)    |                321 | 292 (278×) |       9.55 (9.11×) |  1.05 |
| `small.html.txt` (28 KiB)   |                748 | 650 (325×) |                  — |  2.00 |
| `small.jsonc.txt` (33 KiB)  |                738 | 664 (166×) |       15.4 (3.84×) |  4.00 |
| `small.ts.txt` (31 KiB)     |                336 | 303 (309×) |       8.49 (8.67×) |  0.98 |
| `large.css.txt` (379 KiB)   |                433 | 309 (248×) |       11.5 (9.24×) |  1.25 |
| `large.html.txt` (474 KiB)  |               1115 | 678 (237×) |                  — |  2.86 |
| `large.jsonc.txt` (292 KiB) |               1054 | 894 (148×) |       25.7 (4.26×) |  6.04 |
| `large.ts.txt` (517 KiB)    |                356 | 321 (294×) |       9.09 (8.33×) |  1.09 |
...
| ---------------------------- | -----: | ---------: | ---------: | ------: | ------: |
| `tiny.ts.txt` (2 KiB)        |     76 |    7.74 µs |  241 MiB/s | 1014 µs |    131× |
| `small.ts.txt` (31 KiB)      |    826 |     148 µs |  202 MiB/s | 27.7 ms |    187× |
| `large.ts.txt` (517 KiB)     | 10,826 |    2420 µs |  208 MiB/s |  418 ms |    173× |
| `unicode-lines.ts` (527 KiB) | 10,001 |    2348 µs |  219 MiB/s |  372 ms |    158× |

## Streaming

| Input                        |  Lines | Chunks | Highlights | Throughput |   Shiki | Speedup |
| ---------------------------- | -----: | -----: | ---------: | ---------: | ------: | ------: |
| `tiny.css.txt` (2 KiB)       |     85 |      1 |    9.36 µs |  160 MiB/s | 2158 µs |    231× |
| `tiny.html.txt` (2 KiB)      |     51 |      1 |    9.84 µs |  187 MiB/s | 1086 µs |    110× |
| `tiny.jsonc.txt` (2 KiB)     |     66 |      1 |    8.54 µs |  221 MiB/s |  227 µs |   26.6× |
| `tiny.ts.txt` (2 KiB)        |     76 |      1 |    10.0 µs |  186 MiB/s | 1044 µs |    104× |
| `small.css.txt` (24 KiB)     |  1,388 |      6 |     191 µs |  120 MiB/s | 18.8 ms |   98.5× |
| `small.html.txt` (28 KiB)    |    809 |      7 |     126 µs |  217 MiB/s | 11.0 ms |   87.2× |
| `small.jsonc.txt` (33 KiB)   |  1,105 |      9 |     153 µs |  212 MiB/s | 5220 µs |   34.0× |
| `small.ts.txt` (31 KiB)      |    826 |      8 |     177 µs |  169 MiB/s | 28.2 ms |    160× |
| `large.css.txt` (379 KiB)    | 17,455 |     95 |    2433 µs |  152 MiB/s |  251 ms |    103× |
| `large.html.txt` (474 KiB)   | 11,329 |    119 |    1590 µs |  291 MiB/s |  125 ms |   78.4× |
| `large.jsonc.txt` (292 KiB)  |  8,561 |     74 |     954 µs |  299 MiB/s | 29.0 ms |   30.4× |
| `large.ts.txt` (517 KiB)     | 10,826 |    130 |    2565 µs |  197 MiB/s |  436 ms |    170× |
| `unicode-lines.ts` (527 KiB) | 10,001 |    105 |    2502 µs |  206 MiB/s |  356 ms |    142× |
