...
The throughput, streaming, and live-edit results were recorded on
**2026-09-14**, using Bun 1.4.0 on an Apple M4 Pro (14 cores, 48 GiB RAM, macOS
arm64). The optimized Wasm build measured 151,073 bytes, or 67,538 bytes
gzipped. Those tables preserve one complete run of each mode, executed
sequentially; they are not regenerated by the build. Memory results have their
own recording date below.
