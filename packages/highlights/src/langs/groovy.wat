(module
  ...
  (keyword-table $groovyWords $mem.groovyWords $mem.haskellWords
    ...
    (group $Token.keyword.declaration ;; 4: modifiers and other declarations
      "var" "final" "static" "abstract" "synchronized" "transient" "volatile" "native" "strictfp"
              ...
              (i32.or
                ...
                (i32.and
                  (i32.eq
                    ...
                    (local.get $q))
                  (i32.eq
                    (call $groovyByte (i32.add (global.get $ptr) (i32.const 2)))
                    (local.get $q))))
              (then
                (global.set $ptr
                  (i32.add
    ...
    (block $done
      (loop $next
            ...
            (call $lexBlockComment
              ...
              (select
                ...
                (i32.and
                  ...
                  (i32.ne
                    (call $groovyByte (i32.add (global.get $ptr) (i32.const 3)))
                    (i32.const "/")))))
            (br $next)))
        ...
        (if (i32.or (i32.eq (local.get $c) (i32.const 34)) (i32.eq (local.get $c) (i32.const 39)))
          (then
            (local.set $strKind
              (select (i32.const 3) (i32.const 1) (i32.eq (local.get $c) (i32.const 34))))
            (if
              (i32.and
                                              ...
                                              (select
                                                ...
                                                (i32.and
                                                  ...
                                                  (i32.and
                                                    ...
                                                    (i32.or
                                                      (i32.or
                                                        (call $lexIsIdentStart (local.get $pc))
                                                        (call $lexIsDigit (local.get $pc)))
                                                      (byteset.get "\22'{"
                                                        (local.get $pc)))))))))))))))))))))
