(module
  ...
  (keyword-table $rustWords $mem.rustWords $mem.scalaWords
    ...
    (group $Token.type.builtin ;; 8: primitive types
      "i8" "u8" "i16" "u16" "i32" "u32" "i64" "u64" "f32" "f64" "str" "bool" "char" "isize" "usize")
      ...
      (loop $next
        ...
        (if (i32.eq (local.get $c) (i32.const 39))
          (then
            ...
            (block $lifeDone
              (loop $life
                (br_if $lifeDone
                  (i32.eqz (call $lexIsIdentContinue (call $rustByte (local.get $p)))))
                (local.set $p (i32.add (local.get $p) (i32.const 1)))
                (br $life)))
            (if
              (i32.and
                      ...
                      (else
                        ...
                        (if
                          (i32.and
                            ...
                            (i32.ne
                              (call $rustByte (i32.add (local.get $p) (i32.const 1)))
                              (i32.const "=")))
        ...
        (if (byteset.get "()[]{}" (local.get $c))
          (then
            ...
            (if (i32.eqz (local.get $attr))
              (then (local.set $member (i32.const 0))))
            (local.set $expect (i32.const 0))
            (br $next)))
