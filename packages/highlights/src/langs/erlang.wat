        ...
        (if
          ...
          (then
            (if (i32.eq (local.get $c2) (i32.const 92))
              (then
                (global.set $ptr (call $lexEscapeEnd (i32.add (global.get $ptr) (i32.const 1)))))
              (else
                (global.set $ptr
                      ...
                      (else
                        (if
                          (i32.and
                            ...
                            (call $lexIsDigit
                              (call $erlByte (i32.add (local.get $rhs) (i32.const 1)))))
                          (then (local.set $hl (enum.get $Token.function)))
                          (else
                            (if
                              (i32.and
              ...
              (loop $op
                ...
                (br_if $opDone
                  (i32.and
                    ...
                    (i32.or
                      (i32.eq
                        (i32.and (i32.load16_u (global.get $ptr)) (i32.const 0xffff))
                        (i32.const "<<"))
                      (i32.eq
                        (i32.and (i32.load16_u (global.get $ptr)) (i32.const 0xffff))
                        (i32.const ">>")))))
