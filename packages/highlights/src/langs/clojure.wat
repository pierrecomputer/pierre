(module
  ...
  (keyword-table $clojureWords $mem.clojureWords $mem.cmakeWords
    ...
    (group $Token.keyword.control ;; 5: control flow
      "if" "if-not" "if-some" "when" "when-not" "when-some" "when-first" "cond" "condp" "case"
      "loop" "recur" "for" "doseq" "dotimes" "while" "try" "catch" "finally" "throw" "do")
    (group $Token.keyword ;; 6: special forms and core macros
      "fn" "let" "letfn" "binding" "import" "require" "use" "set!" "var" "quote" "new" "doto"
      "comment")
  ...
  (func $hlClojure
    ...
    (block $done
      (loop $next
        ...
        (if
          (i32.and (i32.eq (local.get $c) (i32.const 92)) (i32.gt_u (local.get $c2) (i32.const 32)))
          (then
            (global.set $ptr
        ...
        (if
          (i32.and
            ...
            (i32.eqz (call $cljIsDelim (local.get $c2))))
          (then
            ...
            (if
              ...
              (then
                ...
                (if
                  (i32.and
                    (i32.eq (local.get $c2) (i32.const "?"))
                    (i32.eq (call $cljByte (global.get $ptr)) (i32.const "@")))
