(module
  ...
  (keyword-table $kotlinWords $mem.kotlinWords $mem.lispWords
    (group $Token.keyword.control ;; 1: control
      "do" "if" "for" "try" "else" "when" "break" "catch" "throw" "while" "return" "finally"
      "continue")
    ...
    (group $Token.type.builtin ;; 8: built-in types
      "Int" "Any" "Long" "Byte" "Char" "Unit" "Float" "Double" "String" "Boolean" "Nothing")
          ...
          (then
            (if
              (i32.or
                ...
                (i32.and
                  (i32.eq
                    (call $kotlinByte (i32.add (global.get $ptr) (i32.const 1)))
                    (i32.const 34))
                  (i32.eq
                    (call $kotlinByte (i32.add (global.get $ptr) (i32.const 2)))
                    (i32.const 34))))
              (then
