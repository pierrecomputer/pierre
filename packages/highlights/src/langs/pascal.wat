(module
  ...
  (keyword-table $pascalWords $mem.pascalWords $mem.perlWords
    (group $Token.keyword.control ;; 1: control flow
      "if" "then" "else" "case" "of" "for" "to" "downto" "while" "do" "repeat" "until" "with"
      "goto" "break" "continue" "exit" "try" "except" "finally" "raise" "on")
    ...
    (group $Token.keyword.declaration ;; 5: sections, types, and directives
      "type" "var" "const" "threadvar" "resourcestring" "label" "interface" "implementation"
      "initialization" "finalization" "class" "record" "object" "packed" "set" "array" "file"
      "property" "published" "public" "private" "protected" "strict" "inherited" "inline"
      "overload" "override" "virtual" "dynamic" "abstract" "reintroduce" "message" "cdecl"
      "stdcall" "safecall" "register" "pascal" "external" "forward" "deprecated" "platform"
      "static" "sealed" "final" "helper" "reference" "out" "absolute" "exports" "dispinterface"
      "generic" "specialize" "experimental" "assembler" "asm")
    ...
    (group $Token.type.builtin ;; 11: built-in types
      "integer" "cardinal" "string" "ansistring" "widestring" "unicodestring" "shortstring" "char"
      "ansichar" "widechar" "boolean" "bytebool" "wordbool" "longbool" "byte" "word" "longint"
      "longword" "int64" "uint64" "shortint" "smallint" "single" "double" "extended" "real" "comp"
      "currency" "pointer" "variant" "olevariant" "tdatetime" "tobject" "textfile" "pchar"
      "pansichar" "pwidechar" "nativeint" "nativeuint")
    (group $Token.keyword+4096 ;; 12: property directives
      "read" "write" "stored" "default" "nodefault" "implements" "index" "dispid" "readonly"
      "writeonly"))
  ...
  (func $pasWordHl (param $lhs i32) (param $rhs i32) (result i32)
    ...
    (local.set $v
      (keyword-table.value $pascalWords
  ...
  (func $pasBraced (param $paren i32)
    ...
    (global.set $ptr
      (i32.add (global.get $ptr) (select (i32.const 2) (i32.const 1) (local.get $paren))))
    (local.set $hl
      (select
            ...
            (if (i32.ge_s (local.get $kind) (i32.const 0))
              (then
                ...
                (if (i32.and (i32.shr_u (local.get $kind) (i32.const 8)) (i32.const 15))
                  (then
                    (local.set $expect
                      (i32.and (i32.shr_u (local.get $kind) (i32.const 8)) (i32.const 15)))))
              ...
              (loop $op
                ...
                (br_if $opDone
                  (i32.and
                    (i32.eq (call $pasByte (global.get $ptr)) (i32.const "/"))
                    (i32.eq
                      (call $pasByte (i32.add (global.get $ptr) (i32.const 1)))
                      (i32.const "/"))))
                (global.set $ptr (i32.add (global.get $ptr) (i32.const 1)))
                (br $op)))
            (call $emitTok (enum.get $Token.operator) (local.get $lhs) (global.get $ptr))
