              ...
              (select
                ...
                (i32.or
                  ...
                  (i32.and
                    (i32.eq (local.get $c3) (i32.const "*"))
                    (i32.ne
                      (call $objcByte (i32.add (global.get $ptr) (i32.const 3)))
                      (i32.const "/"))))))
            (br $next)))
              ...
              (then
                ...
                (local.set $kind
                  (call $objcWordHl
                    ...
                    (i32.const 0)))
                (call $emitTok
                  (i32.and (local.get $kind) (i32.const 255))
                  (local.get $lhs)
                  (global.get $ptr))
                (local.set $expectType
                  (i32.and (i32.shr_u (local.get $kind) (i32.const 8)) (i32.const 1)))
                ;; `@property (attrs)`: the attribute list follows
                (local.set $propAttrs
                  (i32.and (i32.shr_u (local.get $kind) (i32.const 9)) (i32.const 1)))
                (local.set $member (i32.const 0))
                (br $next)))
            (global.set $ptr (i32.add (global.get $ptr) (i32.const 1)))
                  ...
                  (else
                    ...
                    (if
                      ...
                      (then
                        ...
                        (if (local.get $declHead)
                          (then (local.set $declColon (i32.const 1)))))
                      (else
                              ...
                              (i32.and
                                ...
                                (i32.and
                                  ...
                                  (i32.or
                                    ...
                                    (i32.or
                                      (i32.eq (local.get $prev) (i32.const "]"))
                                      (i32.eq (local.get $prev) (i32.const ")"))))))
        ...
        (if
          (i32.and
            ...
            (i32.and
              ...
              (i32.eq
                (call $objcByte (call $lexSkipSpaceAt (i32.add (global.get $ptr) (i32.const 1))))
                (i32.const "("))))
          (then
            (global.set $ptr (i32.add (global.get $ptr) (i32.const 1)))
