(module
  ...
  (func $rRawString (result i32)
    ...
    (if (i32.eq (local.get $close) (i32.const "("))
  ...
  (func $hlR
    ...
    (block $done
      (loop $next
        ...
        ;; `\(x)` lambda
        (if
          (i32.and (i32.eq (local.get $c) (i32.const 92)) (i32.eq (local.get $c2) (i32.const "(")))
          (then
                  ...
                  (else
                    (if
                      (i32.and
                        ...
                        (i32.eq
                          (call $rByte (i32.add (local.get $rhs) (i32.const 1)))
                          (i32.const ":")))
                                  ...
                                  (i32.or
                                    ...
                                    (i32.and
                                      ...
                                      (i32.and
                                        (i32.eq (call $rByte (local.get $p)) (i32.const "="))
                                        (i32.ne
                                          (call $rByte (i32.add (local.get $p) (i32.const 1)))
                                          (i32.const "=")))))
          ...
          (then
            ...
            (if (i32.eq (local.get $c) (i32.const "("))
              (then
                ...
                (if (local.get $atFn)
                  (then (local.set $fnDepth (local.get $paren))))))
            (if (i32.eq (local.get $c) (i32.const ")"))
              (then
