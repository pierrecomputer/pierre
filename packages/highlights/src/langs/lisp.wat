(module
  ...
  (keyword-table $lispWords $mem.lispWords $mem.luaWords
    ...
    (group ;; 4: special forms and macros
      "if" "do" "go" "or" "and" "let" "the" "cond" "case" "flet" "loop" "prog1" "prog2" "progn"
      "setq" "setf" "when" "block" "catch" "throw" "unless" "lambda" "labels" "letrec" "return"
      ...
      "with-open-file" "with-slots" "syntax-rules" "multiple-value-bind" "destructuring-bind"
