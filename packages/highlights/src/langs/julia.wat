(module
  ...
  (keyword-table $juliaWords $mem.juliaWords $mem.kotlinWords
    (group $Token.keyword.control ;; 1: control flow and blocks
      "if" "elseif" "else" "for" "while" "break" "continue" "return" "try" "catch" "finally" "do"
      "begin" "end" "let" "quote")
              ...
              (then
                ...
                (return
                  (i32.and
                    ...
                    (i32.ne
                      (call $jlByte (i32.add (local.get $p) (i32.const 1)))
                      (i32.const "="))))))))
        (br $l)))
    (i32.const 0))
    ...
    (block $done
      (loop $next
        ...
        (if (i32.or (i32.eq (local.get $c) (i32.const 34)) (i32.eq (local.get $c) (i32.const 96)))
          (then
            (local.set $strKind
              (select (i32.const 5) (i32.const 1) (i32.eq (local.get $c) (i32.const 96))))
            (local.set $strHl
              (select
        ...
        (if (i32.eq (local.get $c) (i32.const 39))
          (then
            ...
            (block $hexDone
              (loop $hex
                (br_if $hexDone
                  (i32.ge_u (local.get $e) (i32.add (global.get $ptr) (i32.const 12))))
        ...
        (if
          (i32.and (i32.eq (local.get $c) (i32.const ".")) (i32.eqz (call $jlIsOp (local.get $c2))))
          (then
            (if (i32.eq (local.get $c2) (i32.const "."))
              (then
                (global.set $ptr (i32.add (global.get $ptr) (i32.const 2)))
