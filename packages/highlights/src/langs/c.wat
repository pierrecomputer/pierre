(module
  ...
  (keyword-table $cWords $mem.cWords $mem.c3Words
    (group $Token.keyword.control ;; 1: control
      "do" "if" "for" "case" "else" "goto" "break" "while" "return" "switch" "default")
    (group $Token.keyword.declaration ;; 2: declaration
      "auto" "extern" "inline" "static" "typedef" "register" "_Noreturn" "thread_local"
      "_Thread_local")
    (group $Token.type.builtin ;; 3: built-in types
      "int" "bool" "char" "enum" "long" "void" "float" "short" "union" "_Bool" "double" "signed"
      "struct" "unsigned" "_Complex" "_Imaginary")
    (group $Token.keyword ;; 4: qualifiers and operators
      "const" "sizeof" "typeof" "alignas" "alignof" "restrict" "volatile" "_Atomic" "_Alignas"
      "_Alignof" "_Generic" "constexpr" "static_assert" "typeof_unqual" "_Static_assert")
