              ...
              (then
                (if
                  (i32.eqz
                    (i32.and
                      (i32.eq
                        (call $csByte (i32.add (global.get $ptr) (i32.const 1)))
                        (i32.const 34))
                      (i32.eq
                        (call $csByte (i32.add (global.get $ptr) (i32.const 2)))
                        (i32.const 34))))
                  (then
            ...
            (call $lexBlockComment
              ...
              (select
                ...
                (i32.and
                  (i32.eq (local.get $c3) (i32.const "*"))
                  (i32.ne
                    (call $csByte (i32.add (global.get $ptr) (i32.const 3)))
                    (i32.const "/")))))
            (br $next)))
        ...
        (if (local.get $kind)
          (then
            ...
            (if
              ...
              (else
                (local.set $strKind
                  (select (i32.const 2) (i32.const 1) (i32.and (local.get $kind) (i32.const 2))))
                (global.set $ptr (i32.add (global.get $ptr) (i32.const 1)))))
            (local.set $strKind
              (i32.or
                (local.get $strKind)
