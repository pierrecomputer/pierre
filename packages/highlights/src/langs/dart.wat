(module
  ...
  (keyword-table $dartWords $mem.dartWords $mem.dockerfileWords
    ...
    (group ;; 6: built-in types
      "int" "num" "Map" "Set" "Null" "List" "Type" "bool" "void" "Never" "Future" "Object" "Stream"
      "String" "Symbol" "double" "dynamic" "Function" "Iterable")
          ...
          (then
            (if
              (i32.or
                ...
                (i32.and
                  (i32.eq
                    (call $dartByte (i32.add (global.get $ptr) (i32.const 1)))
                    (local.get $quote))
                  (i32.eq
                    (call $dartByte (i32.add (global.get $ptr) (i32.const 2)))
                    (local.get $quote))))
              (then
            ...
            (call $lexNestedBlockComment
              ...
              (select
                ...
                (i32.and
                  (i32.eq (local.get $c3) (i32.const "*"))
                  (i32.ne
                    (call $dartByte (i32.add (global.get $ptr) (i32.const 3)))
                    (i32.const "/")))))
            (br $next)))
