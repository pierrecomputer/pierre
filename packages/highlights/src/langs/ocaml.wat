(module
  ...
  (keyword-table $mlWords $mem.ocamlWords $mem.pascalWords
    (group $Token.keyword.control ;; 1: control
      "do" "if" "of" "to" "for" "try" "done" "else" "then" "when" "with" "begin" "match" "while"
      "downto" "assert" "function" "lazy")
    ...
    (group $Token.keyword.declaration ;; 5: other declarations
      "in" "as" "val" "end" "fun" "new" "class" "object" "method" "mutable" "private" "virtual"
      "inherit" "external" "exception" "constraint" "initializer")
    (group $Token.keyword.operator ;; 6: word operators
      "or" "mod" "asr" "lsl" "lsr" "lor" "land" "lxor")
    (group $Token.type.builtin ;; 7: built-in types
      "int" "exn" "ref" "char" "bool" "list" "unit" "array" "bytes" "float" "option" "string")
            ...
            (call $lexNestedBlockComment
              ...
              (select
                ...
                (i32.and
                  ...
                  (i32.ne
                    (call $mlByte (i32.add (global.get $ptr) (i32.const 3)))
                    (i32.const ")")))))
            (br $next)))
              ...
              (loop $symbol
                ...
                (br_if $symbolDone
                  (i32.and
                    (i32.eq (i32.load8_u (global.get $ptr)) (i32.const "("))
                    (i32.eq
                      (call $mlByte (i32.add (global.get $ptr) (i32.const 1)))
                      (i32.const "*"))))
                (global.set $ptr (i32.add (global.get $ptr) (i32.const 1)))
                (br $symbol)))
