(module
  ...
  (keyword-table $scalaWords $mem.scalaWords $mem.swiftWords
    ...
    (group $Token.keyword ;; 6: modifiers and other keywords
      "abstract" "final" "sealed" "implicit" "override" "private" "protected" "inline" "opaque"
      "open" "transparent" "infix" "using" "extends" "with" "derives" "new" "forSome" "macro")
          ...
          (then
            (if
              (i32.or
                ...
                (i32.and
                  (i32.eq
                    (call $scalaByte (i32.add (global.get $ptr) (i32.const 1)))
                    (i32.const 34))
                  (i32.eq
                    (call $scalaByte (i32.add (global.get $ptr) (i32.const 2)))
                    (i32.const 34))))
              (then
    ...
    (block $done
      (loop $next
            ...
            (if (i32.eq (call $scalaByte (local.get $rhs)) (i32.const 34))
              (then
                ...
                (if
                  (i32.and
                    (i32.eq
                      (call $scalaByte (i32.add (local.get $rhs) (i32.const 1)))
                      (i32.const 34))
                    (i32.eq
                      (call $scalaByte (i32.add (local.get $rhs) (i32.const 2)))
                      (i32.const 34)))
                  (then
        ...
        (if
          (i32.and
            (i32.eq (local.get $c) (i32.const ":"))
            (i32.eqz (call $scalaIsOp (local.get $c2))))
          (then
            (global.set $ptr (i32.add (global.get $ptr) (i32.const 1)))
            (call $emitTok
              (enum.get $Token.punctuation.delimiter)
