        ...
        (return
          (i32.or
            ...
            (i32.and
              ...
              (i32.or
                (i32.or
                  (i32.eq (local.get $w) (i32.const "if"))
          ...
          (then
            ...
            (if (i32.eqz (local.get $colon))
              (then
                ...
                (local.set $colon
                  (select (i32.const 1) (i32.const 2) (call $lexIsSpace (local.get $c))))))
      ...
      (loop $next
                  ...
                  (i32.and
                    ...
                    (i32.and
                      (i64.eq
                        ...
                        (i64.const "namespac"))
                      (i32.eq
                        (i32.or (i32.load8_u offset=9 (local.get $lhs)) (i32.const 32))
                        (i32.const "e")))))
        ...
        (if
          (i32.and
            ...
            (i32.and
              (i32.ge_u (global.get $cssDialect) (i32.const 2))
              (i32.le_u (local.get $mode) (i32.const 1))))
          (then
            (global.set $ptr (i32.add (global.get $ptr) (i32.const 1)))
            (call $cssScanIdent)
        ...
        (if (i32.or (i32.eq (local.get $c) (i32.const 34)) (i32.eq (local.get $c) (i32.const 39)))
          (then
            ...
            (if (i32.and (i32.ne (local.get $state) (i32.const 0)) (local.get $p))
              (then
                (local.set $span
                  (select (i32.const 2) (i32.const 3) (i32.eq (local.get $c) (i32.const 34))))
                (br $done)))
            (br $next)))
            ...
            (then
              ...
              (if (i32.eq (local.get $c) (i32.const ":"))
                (then
                  ...
                  (call $emitTok
                    (select
                      (enum.get $Token.selector.pseudo)
                      (enum.get $Token.punctuation.delimiter)
              ...
              (i32.or
                ...
                (i32.and
                  ...
                  (i32.and
                    ...
                    (i32.le_u
                      (i32.sub (i32.load8_u offset=2 (global.get $ptr)) (i32.const "0"))
                      (i32.const 9))))))
            (then
              (global.set $ptr (i32.add (global.get $ptr) (i32.const 1)))
              (call $cssScanNumber)
      ...
      (then
        (i32.or
          ...
          (i32.or
            (local.get $mode)
            (i32.or
              (i32.shl (local.get $decide) (i32.const 2))
              (i32.or
                (i32.shl (local.get $attr) (i32.const 3))
                (i32.or
                  (i32.shl (local.get $namespace) (i32.const 5))
                  (i32.or
                    (i32.shl (local.get $span) (i32.const 6))
