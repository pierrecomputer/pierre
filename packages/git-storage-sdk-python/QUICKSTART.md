...
If you already have a unified diff (for example, generated by `git diff`), you can apply it without building file operations manually:
...
- Check out [webhook validation](README.md#webhook-validation) for integrating with events
