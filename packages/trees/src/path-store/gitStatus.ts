...
export interface PathStoreTreesGitStatusState {
  readonly directoriesWithChanges: ReadonlySet<string>;
  readonly signature: string;
  readonly statusByPath: ReadonlyMap<string, GitStatus>;
}

// Git status is keyed by canonical paths in the path-store lane so runtime tree
...
export function resolvePathStoreGitStatusState(
  entries: readonly GitStatusEntry[] | undefined,
  previous: PathStoreTreesGitStatusState | null = null
): PathStoreTreesGitStatusState | null {
