...
let FileTreeReact: typeof import('../src/path-store/react').FileTree;
let PathStoreFileTreeClass: typeof import('../src/path-store').PathStoreFileTree;
let preloadPathStoreFileTree: typeof import('../src/path-store').preloadPathStoreFileTree;
let useFileTree: typeof import('../src/path-store/react').useFileTree;
let useFileTreeSearch: typeof import('../src/path-store/react').useFileTreeSearch;
let useFileTreeSelection: typeof import('../src/path-store/react').useFileTreeSelection;
...
beforeAll(async () => {
  ...
  } = await import('../src/path-store/react'));
  ({ PathStoreFileTree: PathStoreFileTreeClass, preloadPathStoreFileTree } =
...
describe('path-store React lane', () => {
  ...
  test('can remount the same model instance after unmount', async () => {
    const model = new PathStoreFileTreeClass(BASE_OPTIONS);
