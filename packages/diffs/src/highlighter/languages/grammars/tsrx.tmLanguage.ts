...
// Vendored from tsrx-org/tsrx. See the package NOTICE.md for provenance and licenses.
const grammar: LanguageRegistration & {
  ...
  repository: {
    ...
    'tsrx-template-directive': {
      patterns: [
        {
          include: '#tsrx-template-block-directive',
        },
        {
          include: '#tsrx-template-inline-conditional-directive',
        },
        {
          include: '#tsrx-template-conditional-directive',
        },
        {
          include: '#tsrx-template-loop-directive',
        },
        {
          include: '#tsrx-template-switch-directive',
        },
        {
          include: '#tsrx-template-try-directive',
        },
        {
          name: 'keyword.control.directive.tsrx',
          match: '(@)(if|for|switch|try)(?![_$[:alnum:]])',
          captures: {
            '0': {
              name: 'keyword.control.directive.tsrx',
            },
    ...
    'tsrx-template-child-directive': {
      patterns: [
        {
          include: '#tsrx-template-directive',
        },
        {
          include: '#tsrx-template-branch-directive',
        },
      ],
    },
    'tsrx-template-block-directive': {
      name: 'meta.directive.block.tsrx',
      contentName: 'source.js.embedded.tsrx-isolated',
      begin: '(@)(\\{)',
      beginCaptures: {
        '1': {
          name: 'keyword.control.directive.tsrx punctuation.definition.block.tsrx punctuation.definition.block.js',
        },
        '2': {
          name: 'keyword.control.directive.tsrx punctuation.definition.block.tsrx punctuation.definition.block.js',
        },
    ...
    'tsrx-template-inline-conditional-directive': {
      name: 'meta.directive.if.tsrx',
      begin:
        '(@)(if)(?![_$[:alnum:]])(?=\\s*(\\(([^\\(\\)]|(\\(([^\\(\\)]|\\([^\\(\\)]*\\))*\\)))*\\))(?!\\s*\\{))',
      beginCaptures: {
        '0': {
      ...
      patterns: [
        {
          include: '#tsrx-template-directive-header',
        },
        {
          include: '#component-statements',
        },
    ...
    'tsrx-template-switch-case-block': {
      name: 'meta.directive.switch.case.tsrx',
      begin: '(@)(case|default)(?![_$[:alnum:]])(?=[^\\n{}]*:\\s*\\{)',
      beginCaptures: {
        '1': {
          name: 'keyword.control.directive.tsrx',
        },
      ...
      patterns: [
        {
          include: '#tsrx-template-switch-case-body',
        },
        {
    ...
    'tsrx-template-switch-case-body': {
      name: 'meta.directive.block.tsrx',
      contentName: 'source.js.embedded.tsrx-isolated',
      begin: '\\{',
      beginCaptures: {
        '0': {
          name: 'punctuation.definition.block.tsrx punctuation.definition.block.js',
        },
      },
      end: '\\}',
      endCaptures: {
    ...
    'tsrx-template-conditional-directive': {
      name: 'meta.directive.if.tsrx',
      begin: '(@)(if)(?![_$[:alnum:]])',
      beginCaptures: {
        '0': {
      ...
      end: '(?<=\\})(?!\\s*@?else(?![_$[:alnum:]])(?=\\s*(?:\\(|\\{|[^\\n{}]+\\{)))',
      patterns: [
        {
          include: '#tsrx-template-directive-header',
        },
        {
          include: '#tsrx-template-directive-block',
        },
        {
          include: '#tsrx-template-branch-directive',
        },
    ...
    'tsrx-template-loop-directive': {
      name: 'meta.directive.for.tsrx',
      begin: '(@)(for)(?![_$[:alnum:]])',
      beginCaptures: {
        '0': {
          name: 'keyword.control.directive.tsrx',
    ...
    'tsrx-template-switch-directive': {
      name: 'meta.directive.switch.tsrx',
      begin: '(@)(switch)(?![_$[:alnum:]])',
      beginCaptures: {
        '0': {
          name: 'keyword.control.directive.tsrx',
        },
      ...
      patterns: [
        ...
        {
          include: '#tsrx-template-switch-directive-block',
        },
        {
          include: '#comment',
        },
    ...
    'tsrx-template-switch-directive-block': {
      name: 'meta.directive.block.tsrx',
      begin: '\\{',
      beginCaptures: {
        '0': {
      ...
      patterns: [
        {
          include: '#tsrx-template-switch-case-block',
        },
        {
          include: '#comment',
        },
    ...
    'tsrx-template-try-directive': {
      name: 'meta.directive.try.tsrx',
      begin: '(@)(try)(?![_$[:alnum:]])',
      beginCaptures: {
        '0': {
          name: 'keyword.control.directive.tsrx',
    ...
    'tsrx-template-branch-directive': {
      name: 'meta.directive.branch.tsrx',
      begin:
        '(?:(@)(else|empty|pending|catch)|(else|catch))(?![_$[:alnum:]])(?=\\s*(?:\\(|\\{|[^\\n{}]+\\{))',
      beginCaptures: {
        '1': {
          name: 'keyword.control.directive.tsrx',
        },
      ...
      patterns: [
        {
          include: '#tsrx-template-branch-if-directive',
        },
        {
          include: '#tsrx-template-directive-header',
        },
    ...
    'tsrx-template-branch-if-directive': {
      name: 'meta.directive.if.tsrx',
      begin: '(if)(?![_$[:alnum:]])',
      beginCaptures: {
        '1': {
    ...
    'tsrx-template-directive-header': {
      name: 'meta.directive.header.tsrx',
      begin: '\\(',
      beginCaptures: {
        '0': {
      ...
      patterns: [
        {
          ...
          match: '(?<![_$[:alnum:]])(const|let|var)(?![_$[:alnum:]])',
        },
        {
          name: 'keyword.operator.expression.js',
          match: '(?<![_$[:alnum:]])(of|in|key|index)(?![_$[:alnum:]])',
        },
        {
          include: '#expression',
        },
      ...
      patterns: [
        ...
        },
        {
          ...
          captures: {
            ...
            '5': {
              name: 'keyword.keyword.index.tsrx',
            },
            '6': {
              name: 'variable.other.readwrite.js',
            },
            '7': {
              name: 'keyword.keyword.key.tsrx',
            },
            '8': {
              name: 'variable.other.object.js',
            },
    ...
    'expression-operators': {
      patterns: [
        ...
        {
          name: 'keyword.operator.relational.js operator.relational.tsrx-force entity.name.operator.relational.tsrx',
          match: '<=|>=|<>|<|>',
        },
        {
          match: '(?<=[_$[:alnum:]])(\\!)\\s*(?:(/=)|(?:(/)(?![/*])))',
    ...
    jsx: {
      patterns: [
        {
          include: '#jsx-tag-code',
        },
        {
          include: '#jsx-tag-style',
        },
        {
          include: '#jsx-tag-script',
        },
        {
          include: '#jsx-tag-fragment',
        },
        {
          include: '#jsx-tag-dynamic',
        },
        {
      ...
      patterns: [
        ...
        },
        {
          ...
          patterns: [
            ...
            {
              include: '#jsx-code-text',
            },
          ],
        },
      ],
    },
    'jsx-tag-code-in-expression': {
      begin:
        '(?<!\\+\\+|--)(?<=[({\\[,?=>:*]|&&|\\|\\||\\?|\\*\\/|^await|[^\\._$[:alnum:]]await|^return|[^\\._$[:alnum:]]return|^default|[^\\._$[:alnum:]]default|^yield|[^\\._$[:alnum:]]yield|^)\\s*(?=(<)\\s*(code)\\b(?=[\\s>/]))',
      end: '(?!(<)\\s*(code)\\b(?=[\\s>/]))',
      patterns: [
        {
          include: '#jsx-tag-code',
    ...
    'jsx-tag-style-in-expression': {
      begin:
        '(?<!\\+\\+|--)(?<=[({\\[,?=>:*]|&&|\\|\\||\\?|\\*\\/|^await|[^\\._$[:alnum:]]await|^return|[^\\._$[:alnum:]]return|^default|[^\\._$[:alnum:]]default|^yield|[^\\._$[:alnum:]]yield|^)\\s*(?=(<)\\s*(style)\\b(?=[\\s/>]))',
      end: '(?!(<)\\s*(style)\\b(?=[\\s/>]))',
      patterns: [
        {
          include: '#jsx-tag-style',
    ...
    'jsx-tag-script-in-expression': {
      begin:
        '(?<!\\+\\+|--)(?<=[({\\[,?=>:*]|&&|\\|\\||\\?|\\*\\/|^await|[^\\._$[:alnum:]]await|^return|[^\\._$[:alnum:]]return|^default|[^\\._$[:alnum:]]default|^yield|[^\\._$[:alnum:]]yield|^)\\s*(?=(<)\\s*(script)\\b(?![^>]*/>)(?=[^>]*>))',
      end: '(?!(<)\\s*(script)\\b(?![^>]*/>)(?=[^>]*>))',
      patterns: [
        {
          include: '#jsx-tag-script',
    ...
    'jsx-tag-dynamic': {
      name: 'meta.tag.js',
      begin: '(?=<\\{)',
      end: '(/>)|(?:(</)\\s*(\\{)\\s*([[:upper:]][_$[:alnum:]]*(?:\\.[_$[:alpha:]][_$[:alnum:]]*)*)\\s*(\\})\\s*(>))|(?:(</)\\s*(\\{)([^}]*)(\\})\\s*(>))',
      endCaptures: {
        '1': {
          name: 'punctuation.definition.tag.end.js',
        },
        ...
        '4': {
          name: 'meta.embedded.expression.js source.js.embedded.tsrx support.class.component.js',
        },
        '5': {
          name: 'punctuation.definition.tag.end.js',
        },
          ...
          patterns: [
            {
              ...
              contentName:
                'meta.embedded.expression.js source.js.embedded.tsrx',
              patterns: [
                {
                  match:
                    '\\G\\s*([[:upper:]][_$[:alnum:]]*(?:\\.[_$[:alpha:]][_$[:alnum:]]*)*)\\s*(?=\\})',
                  captures: {
                    '1': {
                      name: 'support.class.component.js',
                    },
    ...
    'jsx-text': {
      match:
        '(?:(?![ \\t]*/\\*)(?![ \\t]*@(?:\\{|if|for|switch|try)(?![_$[:alnum:]]))(?![ \\t]*@(?:case|default)(?![_$[:alnum:]])(?=[^\\n{}]*:))(?![ \\t]*@(?:else|empty|pending|catch)(?![_$[:alnum:]])(?=[ \\t]*(?:\\(|\\{|[^\\n{}]+\\{)))(?:@(?!(?:\\{|if|for|switch|try|case|default|else|empty|pending|catch)(?![_$[:alnum:]]))|[^<>{}&@]))+',
    },
    'jsx-code-text': {
      match: '[^<>{}&]+',
    },
    ...
    'module-declaration': {
      name: 'meta.module-declaration.js',
      begin: '\\b(module)\\s+([A-Za-z_$][\\w$]*)\\s*(\\{)',
      beginCaptures: {
        '1': {
          name: 'keyword.control.module.js',
        },
        '2': {
          name: 'entity.name.namespace.module.js',
        },
        '3': {
          name: 'punctuation.definition.block.js',
        },
