...
export interface EditTokenizerProps {
...
export class EditTokenizer {
  ...
  #setStyle: EditTokenizerProps['setStyle'];
  #onDeferTokenize: EditTokenizerProps['onDeferTokenize'];
  #onThemeChange: EditTokenizerProps['onThemeChange'];
  #matchBrackets: boolean;
  #debug: boolean;
  #disposes?: (() => void)[];
  #isCleanedUp = false;
  ...
  pauseBackgroundTokenize(): void {
    ...
    if (this.#debug) {
      console.log('[diffs/edit] background tokenization paused', {
        jobId: this.#backgroundJobId,
      });
    }
    this.#isPaused = true;
  ...
  resumeBackgroundTokenize(): void {
    ...
    if (this.#debug) {
      console.log('[diffs/edit] background tokenization resumed', {
        jobId: this.#backgroundJobId,
      });
    }
    this.#isPaused = false;
  ...
  #scheduleBackgroundTokenize(
    ...
    if (this.#debug) {
      console.log('[diffs/edit] background tokenization scheduled', {
        jobId,
        startLine,
        changedLineRanges,
        changedRangeIndex,
