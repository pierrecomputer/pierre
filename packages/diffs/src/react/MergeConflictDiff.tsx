...
export interface MergeConflictDiffOptions<LAnnotation> extends FileDiffOptions<
...
export interface MergeConflictDiffProps<LAnnotation> extends Omit<
  FileDiffProps<LAnnotation | MergeConflictActionAnnotationMetadata>,
  'fileDiff' | 'options' | 'lineAnnotations' | 'renderAnnotation'
> {
  file: FileContents;
  options?: MergeConflictDiffOptions<LAnnotation>;
  lineAnnotations?: DiffLineAnnotation<LAnnotation>[];
  renderAnnotation?(annotation: DiffLineAnnotation<LAnnotation>): ReactNode;
}

export function MergeConflictDiff<LAnnotation = undefined>({
  file,
  options,
  lineAnnotations,
  renderAnnotation,
  ...props
}: MergeConflictDiffProps<LAnnotation>): React.JSX.Element {
