...
import { type Marker, MarkerRenderer } from '../src/edit/marker';
import { PopoverManager } from '../src/edit/popover';
import type { TextDocument } from '../src/edit/textDocument';
...
describe('Edit marker popup placement', () => {
  ...
  test('places the popup below the marker by default', async () => {
    const MULTILINE = 'l0\nl1\nl2\nl3\nl4\nl5\nl6\nl7\nl8\nl9';
    const { cleanup, edit, content } = await createMarkerFixture(MULTILINE);
