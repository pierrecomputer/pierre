...
function stackEntry(
  ...
  versionAfter: number,
  selectionsBefore?: EditSelection[],
  selectionsAfter?: EditSelection[]
) {
...
describe('shouldCoalesceEditStackEntry', () => {
  ...
  // A newline insert must never merge into the typing before it. The edit
