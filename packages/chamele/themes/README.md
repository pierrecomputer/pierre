...
Chamele bundles themes matching all 65 IDs, names, and appearances in
...
import { pierreDark, vitesseDark } from '@pierre/chamele/themes';
...
```js
import { toCSS, pierreDark } from '@pierre/chamele/themes';
...
`appearance`, and the style keys Chamele and `@pierre/diffs` read; unrelated
