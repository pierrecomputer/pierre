...
t.test('wat: module forms, instructions, identifiers, and literals', () => {
  const src =
...
t.test('wat: structured control words', () => {
...
t.test('wat: line and nested block comments', () => {
  const src =
...
t.test('wat: malformed and split ranges stay lossless', () => {
